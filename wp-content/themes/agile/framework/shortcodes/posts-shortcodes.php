...
function mo_recent_posts_shortcode($atts) {
    ...
    $args['query_args'] = array('posts_per_page' => $post_count, 'author' => $author, 'ignore_sticky_posts' => 1);
...
function mo_custom_taxonomy_posts_shortcode($atts) {
    ...
    $args['query_args'] = array('tax' => $taxonomy_wrap, 'posts_per_page' => $post_count, 'ignore_sticky_posts' => 1);
