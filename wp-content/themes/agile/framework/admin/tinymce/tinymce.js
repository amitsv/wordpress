...
function getshortcodeText(selectedShortcode) {
    ...
    if (selectedShortcode == "segment") {
        shortcodeText = '[segment id="" class="" style="" background_image="http://example.com/x.png" background_pattern="http://example.com/y.png" background_color="#dedede" fixed_background="true"]<p>Replace with your segment content here</p>[/segment]';
    ...
    if (selectedShortcode == 'default_button') {
        shortcodeText = "[button size=\"small,medium,large\" type=\"rounded\" color=\"default\" href=\"http://www.\" ]Replace with your content[/button]<br />";
        return shortcodeText;
    }
    ...
    if (selectedShortcode == 'cyan_button') {
        shortcodeText = "[button size=\"small,medium,large\" type=\"rounded\" color=\"cyan\" href=\"http://www.\" ]Replace with your content[/button]<br />";
        return shortcodeText;
    }
    ...
    if (selectedShortcode == 'teal_button') {
        shortcodeText = "[button size=\"small,medium,large\" type=\"rounded\" color=\"teal\" href=\"http://www.\" ]Replace with your content[/button]<br />";
        return shortcodeText;
    }
    ...
    if (selectedShortcode == 'show_post_snippets') {
        shortcodeText = "[show_post_snippets post_count=9 number_of_columns=3 post_type=\"Type1,Type2\" image_size=\"Medium\"]<br />";
        return shortcodeText;
    }

    if (selectedShortcode == 'show_portfolio') {
        shortcodeText = "[show_portfolio post_count=9 number_of_columns=3 image_size=\"Medium\" filterable=true]<br />";
        return shortcodeText;
    }

    if (selectedShortcode == 'show_gallery') {
        shortcodeText = "[show_gallery post_count=9 number_of_columns=3 image_size=\"Medium\" filterable=true]<br />";
        return shortcodeText;
    }
